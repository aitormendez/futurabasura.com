...
<li <?php wc_product_class( wp_is_mobile() ? 'infinite-scroll-item w-full flex justify-center mb-10' : 'infinite-scroll-item card', $product); ?>>
        <?php     
             ...
             * @hooked renderizar_card_front - 10
             * @hooked mostrar_etiqueta_nuevo_producto - 15
             * @hooked renderizar_card_back - 15
...
<?php /**PATH /srv/www/futurabasura.com/current/web/app/themes/sage/resources/views/woocommerce/content-product-portada.blade.php ENDPATH**/ ?>