<footer class="flex flex-wrap mt-20">
    ...
    <div class="flex flex-wrap w-full md:w-1/2 bg-white font-bugrino md:text-xl font-light">
        <ul class="w-1/2 h-[50vw] md:h-[25vw] p-6 border-r-2 border-b-2 border-black">
            ...
            <li>
                <a href="<?php echo e($item->url); ?>" class="hover:text-azul font-light"><?php echo e($item->label); ?></a>
            </li>
    ...
    <div class="flex md:!hidden flex-wrap w-full font-bugrino">
        ...
        <div class="abajo flex flex-wrap w-full h-[50vw]">
            ...
            <div class="der flex w-1/2 text-sm p-4" style="background-color: <?php echo e(get_field('footer_color', 'option')); ?>">
                <?php echo wpautop(get_field('footer_texto_mancha', 'option')); ?>
...
</footer><?php /**PATH /srv/www/futurabasura.com/current/web/app/themes/sage/resources/views/sections/footer.blade.php ENDPATH**/ ?>