<div id="solapa"
    class="fixed top-0 z-40 w-screen h-screen bg-white pointer-events-none flex flex-col justify-center items-center md:flex-row flex-wrap">
    <ul class="my-4 contenidos flex flex-col items-center md:mx-12">
        <?php if(!empty($contents_nav)): ?>
        ...
        <li class="border border-black">
            <a href="<?php echo e($item->url); ?>"
                class="inline-block px-4 pt-3 pb-2 text-sm tracking-widest text-black bg-white hover:bg-allo uppercase sm:text-xl"><?php echo e($item->label); ?></a>
        </li>
...
<header class="top-0 z-30 flex w-full banner font-sans">
    <nav class="w-full">
        <ul class="flex">
            <li class="inline-block p-4 li-brand sm:block sm:pt-8 max-w-[70%]">
                <a id="brand" class="brand nav-item hover:text-allo"" href=" <?php echo e(home_url('/')); ?>">
                    <?php echo e($frase); ?>

                </a>
            </li>
            <?php if(!empty($primary_nav)): ?>
            <?php $__currentLoopData = $primary_nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="p-4 li-shop sm:pt-8">
                <a href="<?php echo e($item->url); ?>" class="nav-item hover:text-allo"><?php echo e($item->label); ?></a>
            </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            <li class="li-cart">
                <a href="/cart" class="flex cart-link nav-item hover:text-allo">
                    ...
                    <div class="flex flex-col hole">
                        <div class="font-serif font-bold text-center bg-white num-items text-azul">
                            <?php echo e($items_cart); ?>

                        </div>
                        <div class="hole-cell">
                            <?php echo e(get_svg('images.cart-hole-min')); ?>
                        </div>
...
</header><?php /**PATH /srv/www/futurabasura.com/current/web/app/themes/sage/resources/views/sections/header.blade.php ENDPATH**/ ?>