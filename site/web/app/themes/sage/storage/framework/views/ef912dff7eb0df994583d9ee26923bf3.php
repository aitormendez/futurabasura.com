...
<?php if($product->is_in_stock()): ?>
    ...
    <div class="hidden">
      ...
      <?php do_action( 'woocommerce_after_add_to_cart_quantity' ) ?>
        ...
        <div class="inline-block" >
          <div class="flex justify-between my-3 text-sm bg-white mr-6">
            <?php if($precio['is_on_sale']): ?>
              <div class="flex items-center px-4 text-rojo text-2xl price-on-sale"><del><?php echo e($precio['regular_price']); ?></del> <del class="block woocommerce_price_euro_letter">&nbsp;EUR</del></div>
            <?php endif; ?>
		...
		<button type="submit" name="add-to-cart" value="<?php echo e($product->get_id()); ?>" class="px-20 py-3 bg-azul clip-path-elipse text-white uppercase tracking-max hover:bg-allo hover:text-black transition-colors"><?php echo e($product->single_add_to_cart_text()); ?></button>
