									...
									<table border="0" cellpadding="10" cellspacing="0" width="100%">
										...
										<tr>
											<td id="footer-section-body">
												<a href="<?php echo e(home_url('/')); ?>">futurabasura.com</a>
										...
										<tr>
											<td id="footer-section-title">
												<h2><a href="<?php echo e(home_url('/newsletter')); ?>">FB Newsletter</a></h2>
											</td>
										</tr>
										<tr>
											<td id="footer-section-img">
												<img src="<?php echo e(home_url('/app/themes/fb/public/images/email-hole.png')); ?>" alt="hole-logo">
