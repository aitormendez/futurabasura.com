...
@if ($related_products)
    ...
    <section class="related products order-3 mt-40 w-full">
                        ...
                        <ul class="glide__slides">
                            @foreach ($product['product_gallery'] as $img)
                                <li class="glide__slide">
                                    <img class="block" src="{!! $img['att_url'] !!}" srcset="{!! $img['att_srcset'] !!}"
                                        @if ($img['has_alt']) alt="{!! $img['alt'][0] !!}" @endif
        ...
        @php
            $heading = apply_filters(
                ...
                __('You may be interested', 'woocommerce'),
            );
        @endphp

        @if ($heading)
            <h2 class="m-6 mt-40 text-center font-bold uppercase tracking-widest">{{ $heading }}</h2>
        @endif
        ...
        @foreach ($related_products as $related_product)
            ...
            <h3 class="w-full bg-white px-6 py-1">
