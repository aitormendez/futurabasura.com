...
<div id="product-{{ get_the_ID() }}" {!! wc_product_class('flex flex-wrap', $product) !!}>
    ...
    <div
        class="order-1 flex w-full flex-col items-center bg-white px-6 pb-20 pt-6 text-xl md:-order-1 md:border-b-2 md:pt-14">
