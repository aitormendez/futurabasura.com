<x-html-forms :form="$form" class="my-form">
    ...
    <label for="participate-DOWNLOAD_LINK" class="font-fk mb-0 font-bold">Download Link</label>
    ...
    <input type="url" name="DOWNLOAD_LINK" placeholder="https://example.com/myfile.zip" required
        id="participate-DOWNLOAD_LINK" class="mb-2 w-full bg-white p-4" aria-describedby="download-link-description">

    <input type="submit" value="Submit"
        class="!bg-azul font-fk mx-auto my-10 block px-20 py-4 text-sm uppercase tracking-widest text-white" />
</x-html-forms>
