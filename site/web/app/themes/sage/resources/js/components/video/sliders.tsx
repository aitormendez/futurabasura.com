...
export function Time({ thumbnails }: TimeSliderProps) {
  ...
  return (
    ...
    >
      ...
      {/* Preview */}
      <div
        className="flex flex-col items-center absolute opacity-0 data-[visible]:opacity-100 transition-opacity duration-200 will-change-[left] md:pointer-events-none"
        ref={previewRef}
      >
        {thumbnails ? (
          <Thumbnail.Root
