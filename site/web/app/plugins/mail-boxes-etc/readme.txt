...
MBE eShip, the Mail Boxes Etc.'s plugin for e-commerce platforms, functions as an integrator between your online store and the MBE's Systems, allowing you to offer different types of shipments and service levels to your customers, with all the distinctive quality and longstanding experience offered by Mail Boxes Etc. MBE e-Link is free of charge, easy to install and configure, enabling automatic data transfer, such as recipients, parcels information and tracking codes, between MBE's Systems and the e-commerce, allowing you to use only a single platform and stay focused on your business.
...
= 2.0.1 =
* Fixed a bug for Waybill option synchronization
